...
<body>
			...
			<div class="ms-sm-auto col-md-12 col-lg-10 px-md-4 mb-5"
				...
				<div class="card">
					<div
						...
						<h1 class="h2 mx-3 p-3 wow fadeIn" id="chart-title">${list[0].regionName}
							질병 정보</h1>
					</div>
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="row no-gutters align-items-center">
											...
											<div
												class="text-xs font-weight-bold text-uppercase mb-1 heading">
												<h4 class="card-title wow fadeIn">${list[0].regionName}</h4>
												<select class="form-select form-select-lg mb-3 wow fadeIn"
													id="region-select">
	...
	<!-- script 파일 복붙시 수정 -->
	  ...
	  <script src = "<c:url value = '/js/diseaseChart.js'/>"></script>
