...
<link href= "<c:url value = '/css/lib/animate/animate.css' /> " rel="stylesheet">
		...
		<div id="header-carousel" class="carousel slide"
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img class="w-100" src = "<c:url value = '/img/city-1.jpg'/>">
							...
							<div class="row justify-content-start">
								<div class="col-lg-8 text-start">
									...
									<button type="button" class="btn btn-warning btn-lg mt-1">
										<a href="${pageContext.request.contextPath}/disease" style="color: black;">서비스 바로가기</a>
									</button>
								</div>
							</div>
						</div>
				...
				<div class="carousel-item">
					<img class="w-100" src = "<c:url value = '/img/city-2.jpg'/>">
					<div class="carousel-caption">
						<div class="container">
							<div class="row justify-content-end">
								<div class="col-lg-8 text-end">
									...
									<button type="button" class="btn btn-warning btn-lg mt-1">
										<a href="${pageContext.request.contextPath}/life" style="color: black;">서비스 바로가기</a>
									</button>
								</div>
							</div>
						</div>
				...
				<div class="carousel-item">
					<img class="w-100" src = "<c:url value = '/img/city-3.jpg'/>">
					<div class="carousel-caption">
						<div class="container">
							<div class="row justify-content-end">
								<div class="col-lg-8 text-end">
		...
		<div class="container mt-5 mb-5">
			<div class="row" id="sectionContainerBox">
				<div class="col-md-6 px-5 section">
					...
					<img class="img-fluid mb-4 wow fadeInUp" data-wow-delay="0.3s" src = "<c:url value = '/img/map-2.jpg'/>">
				</div>
							...
							<table id="board-table"
								...
								<tbody>
									<c:forEach var="dto" items="${boardList}" varStatus="status"
										...
										<tr>
											<td>${status.count}</td>
											<td><a href="${pageContext.request.contextPath}/boardView/${dto.boardId }"
												style="text-decoration: none">${dto.boardTitle}</a></td>
											<td>${dto.userName}</td>
											<td>${dto.boardDate}</td>
										</tr>
									</c:forEach>
	...
	<div id="sectionService">
		<div id="intro-container" class="container wow fadeInUp">
			<div id="intro-one" class="imgBox wow fadeInUp" data-wow-delay="0.3s">
				...
				<div id="one-text">
					<div class="text1">질병 정보 확인</div>
					<button type="button" class="btn btns btn-outline-light"
						style="background-color: gray;">
						<a href="${pageContext.request.contextPath}/disease" style="color: white;">자세히 알아보기</a>
					</button>
				</div>
			</div>
			<div id="intro-three" class="imgBox wow fadeInUp"
				...
				<div id="three-text">
					<div class="text3">기대 수명 예측</div>
					<button type="button" class="btn btns btn-outline-light"
						style="background-color: gray;">
						<a href="${pageContext.request.contextPath}/life" style="color: white;">자세히 알아보기</a>
					</button>
				</div>
			</div>
		</div>
