    ...
    <script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script> -->
        ...
        <body>
            ...
            <div id="conatain" class="board_wrap">
                ...
                <form action="${pageContext.request.contextPath}/editBoard" method="post" id="editForm">
                    ...
                    <div class="board_write_wrap">
                        <div class="board_write">
                            <div class="title">
                                <dl>
                                    <dt>제목</dt>
                                    <dd><input type="text" placeholder="제목 입력" name="boardTitle" id = "title"
                                            value="${board.boardTitle}"></dd>
                                </dl>
                            </div>
                            <div class="info">
                                <dl>
                        ...
                        <div class="bt_wrap">
                            ...
                            <a href="${pageContext.request.contextPath}/boardView/${board.boardId }">취소</a>
                            <a href="${pageContext.request.contextPath}/deleteBoard/${board.boardId}">삭제</a>
                        </div>
