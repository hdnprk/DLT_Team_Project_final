...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/seoulHealth.css">
	...
	<div id="contain">
		<div class="container">
			...
			<div class="side-menu">
				<div>
					<div class="text2">
						<a href="${pageContext.request.contextPath}/">홈</a> > <a href="${pageContext.request.contextPath}/policy">정책</a> > 서울 > 어르신
						건강 증진
					</div>
				</div>
				...
				<div class="e_imgBox">
					<div class="e_img_seoullogo">
						...
						<a href="https://www.seouldementia.or.kr/" target="_blank"><img
							src="${pageContext.request.contextPath}/img/seoul_logo.gif" alt="서울시 광역치매센터 로고"></a>
