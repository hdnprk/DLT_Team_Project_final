...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/seoulLife.css">
			...
			<div class="side-menu">
				<div>
					<div class="text2">
    					...
    					<a href="${pageContext.request.contextPath}/policy">정책</a> > 
    					서울 > 생활 안전 지원
					</div>
				</div>
			...
			<div>
				...
				<div class="bs_box">
					<span class="bs_textbox"> <span class="bs_line_1"><strong><br>기초연금
							...
							src="${pageContext.request.contextPath}/img/icon-right-chevron.png" alt=""></span>
