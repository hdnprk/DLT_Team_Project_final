...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/seoulWelfare.css">
		...
		<div class="container">
			...
			<div class="side-menu">
				<div>
					<div class="text2">
						<% if(regionId == 1){ %>
						<a href="${pageContext.request.contextPath}/">홈</a> > <a href="${pageContext.request.contextPath}/policy">정책</a> > 서울 > 여가 복지 지원
						<% } %>
						<% if(regionId == 2){ %>
						<a href="${pageContext.request.contextPath}/">홈</a> > <a href="${pageContext.request.contextPath}/policy">정책</a> > 전남 > 여가 복지 지원
						<% } %>
					</div>
				</div>
			...
			<%
							List<PolicyVO> welfare = (ArrayList<PolicyVO>) request.getAttribute("welfareDtos");
						%>
			<div>
