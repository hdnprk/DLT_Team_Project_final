...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/jeonnamHealth.css">
	...
	<div id="contain">
		<div class="container">
			...
			<div class="side-menu">
				<div>
					<div class="text2">
						<a href="${pageContext.request.contextPath}/">홈</a> > <a href="${pageContext.request.contextPath}/policy">정책</a> > 전남 > 어르신
						건강 증진
					</div>
				</div>
			...
			<div>
				<div class="e_img_nidlogo">
					<a href="https://www.nid.or.kr/main/main.aspx" target="_blank"><img
						src="${pageContext.request.contextPath}/img/nid_logo.jpg" alt="중앙치매센터로고"></a>
				</div>
			...
			<div>
				<div class="e_imgBox">
					<div class="e_img_seoullogo">
						...
						<a href="https://www.seouldementia.or.kr/" target="_blank">
						<img src="${pageContext.request.contextPath}/img/seoul_logo.gif" alt="서울시 광역치매센터 로고"></a>
					...
					<div class="e_img_jeonnamlogo">
						...
						<a href="https://jeonnam.nid.or.kr/home/main/main.aspx"
							target="_blank"><img src="${pageContext.request.contextPath}/img/jeonnam_logo.png"
				...
				<div class="downloadBox">
					<a
						...
						target="_blank"> <img src="${pageContext.request.contextPath}/img/img_google.png" alt="구글다운로드"></a>


					<a
						href="https://apps.apple.com/kr/app/%EC%B9%98%EB%A7%A4%EC%B2%B4%ED%81%AC/id664587531?l=en-GB?l=en"
						target="_blank"> <img src="${pageContext.request.contextPath}/img/img_apple.png" alt="애플다운로드"></a>
