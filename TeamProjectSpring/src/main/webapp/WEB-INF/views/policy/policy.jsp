...
<head>
	...
	<link href = "<c:url value = '/css/policy.css' /> " rel = "stylesheet">
            ...
            <div id="intro-container-policy" class="container wow fadeInUp">
                <div id="intro-one-policy" class="imgBox wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div id="one-text-policy">
                        ...
                        <form action="<c:url value='/policy/job' />" method="get">
    						<input type="hidden" name="region_id" value="1" />
    							<button type="submit" class="btn btns btn-outline-light" style="background-color: gray;">
        						자세히 알아보기
    							</button>
						</form>
                    </div>
...
<%--     <script src="<c:url value = '/js/policyMap.js' />"></script> --%>
</body>
</html>