...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/jeonnamLife.css">
	...
	<div id="contain">
		<div class="container">
			...
			<div class="side-menu">
				<div>
					<div class="text2">
						<a href="${pageContext.request.contextPath}/">홈</a> > <a href="${pageContext.request.contextPath}/policy">정책</a> > 전남 >생활
						안정 지원
					</div>
				</div>
			...
			<div>
				...
				<div class="bj_box">
					<span class="bj_textbox"> <span class="bj_line_1"><strong><br>신청인<br></strong>
							...
							src="${pageContext.request.contextPath}/img/icon-right-chevron.png" alt="화살표"><br>신청</span>
					</span> <span class="bj_textbox"> <span class="bj_line_2"><strong>읍면동</strong></span>
					</span> <span class="bj_chevron"> <span><img
							src="${pageContext.request.contextPath}/img/icon-right-chevron.png" alt="화살표"><br>전달</span>
					</span> <span class="bj_textbox"> <span class="bj_line_3"><strong>시·군</strong></span>
					</span> <span class="bj_chevron"> <span><img
							src="${pageContext.request.contextPath}/img/icon-right-chevron.png" alt="화살표"><br>통지(30일)</span>
